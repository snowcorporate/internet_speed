...
/** InternetSpeedPlugin */
public class InternetSpeedPlugin(internal var activity: Activity, internal var methodChannel: MethodChannel, registrar: Registrar) : MethodCallHandler {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "internet_speed")
            channel.setMethodCallHandler(InternetSpeedPlugin(registrar.activity(), channel, registrar))
        }
    }
